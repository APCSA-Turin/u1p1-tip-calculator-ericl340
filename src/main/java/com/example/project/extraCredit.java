...
public class ExtraCredit {
    ...
    public static String calculateTip(int people, int percent, double cost, String str) { //You must use these  variable in your calculations
     ...
     public static void main(String[] args) {
        ...
        System.out.println(calculateTip(people,percent,cost,temp2));
    }
}